...
def _build_graph():
    ...
    builder.add_node("propose_remediation_node", propose_remediation_node)
    ...
    builder.add_edge("rag_node",          "propose_remediation_node")
    builder.add_edge("propose_remediation_node", "build_report_node")
    # External dispatches happen before persistence so their outcomes are saved.
    builder.add_edge("build_report_node", "escalate_node")
    builder.add_edge("escalate_node",     "send_email_node")
    builder.add_edge("send_email_node",   "save_run_node")
    builder.add_edge("save_run_node",     END)
